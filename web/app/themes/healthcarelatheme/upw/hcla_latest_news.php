<?php
/**
 * Custom HealthCareLA Latest News ultimate posts widget template
 *
 * @version     2.0.0
 */
?>
...
<div class="upw-posts hfeed hcla-latest-news">

    <a class="widget-title" href="<?php echo get_bloginfo();?>/news"><div class="top_title">Latest News <div class="top_title_topics">(3 items)</div></div></a>
            ...
            <?php if ($instance['show_date'] || $instance['show_author'] || $instance['show_comments']) : ?>
              ...
              <div class="entry-meta">
                ...
                <?php if ($instance['show_date']) : ?>
                  <time class="published" datetime="<?php echo get_the_time('c'); ?>"><?php  the_time();//echo get_the_time($instance['date_format']); ?></time>
                <?php endif; ?>
